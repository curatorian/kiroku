defmodule KirokuWeb do
  ...
  def static_paths, do: ~w(assets fonts images favicon.ico kiroku.ico)
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: KirokuWeb.Endpoint,
        router: KirokuWeb.Router,
        statics: KirokuWeb.static_paths()
    end
  end
